...
st.set_page_config(page_title="Predicciones en Google Trends", page_icon="📈",
...
st.write(
    "Visualizado en [![this is an image link](https://i.imgur.com/iIOA6kU.png)](https://www.streamlit.io/) por el departamento de Data de Grupo Alivia")
